...
},{"./Utils/StringReplacer":33,"debug":1}],13:[function(require,module,exports){
'use strict';
...
},{"./AddButton":11,"./Models/DiceModel":23,"./SaveButton":27,"./Utils/StringReplacer":33,"debug":1}],15:[function(require,module,exports){
'use strict';
...
},{"./DecisionCardView":12,"./Models/ComponentState":21,"./Models/DecisionListState":22,"./Models/UserState":25,"./Utils/ClearHTML":31,"debug":1}],21:[function(require,module,exports){
'use strict';
...
var User = function () {
  ...
  _createClass(User, [{
    ...
    key: 'checkAuth',
    value: function checkAuth(diceId) {
      return new Promise(function (res, rej) {
...
var getStateObject = function getStateObject() {
  return USER_STATE;
};

exports.default = { addUser: addUser, removeUser: removeUser, addDiceId: addDiceId, getState: getState, getStateObject: getStateObject };
...
if (userAuth === 'authed') {
  _UserModel2.default.checkAuth().then(function (userObject) {
    _UserState2.default.removeUser();
    _UserState2.default.addUser(userObject);
  }).catch(function () {
    userAuth = unauthed;

...
var diceEditView = function diceEditView(ctx) {
  ...
  console.log('id = ' + id);
  return Promise.all([_DecisionListState2.default.getDiceById(ctx.params.decisionId), _ComponentState2.default.getComponent('decision-edit-page'), _ComponentState2.default.getComponent('decision-edit-face'), _ComponentState2.default.getComponent('decision-edit-option'), _ComponentState2.default.getComponent('save-button'), _ComponentState2.default.getComponent('delete-button')]).then(function (data) {
    console.log(data);
    if (!data[0]) {

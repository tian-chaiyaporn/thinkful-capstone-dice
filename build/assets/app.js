...
var _DicePageViewManager = require('./DicePageViewManager.js');

var _DicePageViewManager2 = _interopRequireDefault(_DicePageViewManager);

var _DiceEditViewManager = require('./DiceEditViewManager.js');
...
var createDiceEditPage = function createDiceEditPage(dice, pageLayout, diceHeaderComponent, optionComponent) {
  ...
  $('.js-add-option').focus(function () {
    return addOptionToDOM(dice, optionComponent);
  });
  $('.js-save-dice').click(function (e) {
    dice.saveToDb($('.js-input-title').val(), $('.js-input-description').val()).then(function () {
      return page('/dice/' + dice._id);
    }).catch(function (err) {
  ...
  $('.js-delete-dice').click(function () {
    dice.deleteFromDb().then(function () {
      return _DiceEditViewManager2.default.deleteDiceFromCache(dice);
    }).then(function () {
      return page('/');
    }).catch(function (err) {
...
},{"./DiceEditViewManager.js":10,"./DicePageViewManager.js":12,"./Utils/StringReplacer":19,"uuid/v4":7}],10:[function(require,module,exports){
'use strict';
...
exports.default = { diceEditView: diceEditView, deleteDiceFromCache: deleteDiceFromCache };

},{"./DiceEditView":9,"./Models/ComponentState":14,"./Models/DecisionListState":15,"./Utils/ClearHTML":17}],11:[function(require,module,exports){
'use strict';
...
},{"./DicePageView":11,"./Models/ComponentState":14,"./Models/DecisionListState":15,"./Utils/ClearHTML":17}],13:[function(require,module,exports){
'use strict';
...
},{"./DiceModel":16}],16:[function(require,module,exports){
'use strict';

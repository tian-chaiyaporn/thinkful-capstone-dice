...
var createDiceEditPage = function createDiceEditPage(dice, pageLayout, diceHeaderComponent, optionComponent) {
  ...
  $('.js-save-dice').click(function () {
    dice.saveToDB($('.js-input-title').val(), $('.js-input-description').val()).then(function () {
      ...
      _DicePageViewManager2.default.diceView({ params: { decisionId: dice._id } });
    }).catch(function (err) {
...
},{"./DicePageViewManager.js":12,"./Utils/StringReplacer":19,"uuid/v4":7}],10:[function(require,module,exports){
'use strict';
